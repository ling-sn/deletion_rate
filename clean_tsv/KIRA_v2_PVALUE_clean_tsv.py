...
class FilterTSV:
   ...
   ## TODO: Change merged_wt_7ko_tsv to merged_reps_tsv
   def merge_BS_NBS(self, fraction, merged_reps_tsv, bs_nbs_dir):
      matches = [tsv for tsv in merged_reps_tsv if re.search(fraction, tsv.stem)]
      df_list = [pd.read_csv(str(file), sep = "\t") for file in matches]
   ...
   ## TODO: Change merged_reps_tsv to pvals_tsv / Change wt_7ko_dir to final output dir 
